<?php
	...
	if(isset($_GET['srv'])) {
		...
		if($sampquery->isOnline()) {
			...
			imagettftext($sign, 11, 0, 22, 80, $fontcolor, $font, $lang['players'] . ': ' . $sinfos['players'] . '/' . $sinfos['maxplayers']);
			
			imagettftext($sign, 11, 0, 22, 110, $fontcolor, $font, $lang['gamemode'] . ': ' . $sinfos['gamemode']);
			imagettftext($sign, 11, 0, 22, 140, $fontcolor, $font, $lang['map'] . ': ' . $sinfos['mapname']);
		}
		else {
