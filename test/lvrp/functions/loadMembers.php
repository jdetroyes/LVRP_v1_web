...
if(isset($_POST['search']))
							{
				    $sql           = "SELECT * FROM lvrp_users WHERE `Name` LIKE '".mysql_real_escape_string($_POST['search'])."'"; // Formule de requête.
					$req           = mysql_query($sql) or die (mysql_error()); // Requête.
						if(mysql_num_rows($req))
							...
							while($data = mysql_fetch_array($req))
									{
									?>
									<b>Resulta de recherche</b><br>
									<a href='public.php?id=<?php echo $data['id'];?>'><?php echo $data['Name'];?></a><br>
									<hr>
									<br><br><br>
									<?php
									}
