                ...
                switch($_GET['do'])
                {
					...
					case 'error14':
						...
						<div id="InValide">
							<div class="Title"></div>
							<div class="Content">
								Erreur, Vous devez être déconnecté du serveur. <a href=profil.php?do=boutique>Boutique</a>
								<br><br><i><h6>Vous allez être rédigé automatiquement ...</h6></i>
							</div>
							<div class="End"></div>
						</div>');
						echo '<META HTTP-EQUIV="Refresh" CONTENT="3; profil.php?do=boutique"> ';
						break;
					case 'error15':
						echo char('
						<div id="InValide">
							<div class="Title"></div>
							<div class="Content">
								Erreur, Vous n\'avez pas assez de tokens. <a href=profil.php?do=boutique>Boutique</a>
								<br><br><i><h6>Vous allez être rédigé automatiquement ...</h6></i>
							</div>
							<div class="End"></div>
						</div>');
